 ...
 *
 * Uses the [TestCoroutineDispatcher] if provided. Otherwise it uses a new single thread
 * executor.
...
class ViewModelScopeMainDispatcherRule(
    private val testContext: TestCoroutineDispatcher? = null
) : TestWatcher() {
    ...
    override fun starting(description: Description?) {
        ...
        if (testContext != null) {
            Dispatchers.setMain(testContext)
        } else {
